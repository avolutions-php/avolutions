...
define(__NAMESPACE__.'\\APPLICATION_PATH', realpath($_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR).DIRECTORY_SEPARATOR.APPLICATION.DIRECTORY_SEPARATOR);
