...
### Manually
The latest version can be downloaded at [Github](https://github.com/avolutions/avolutions/archive/v0.3.0-alpha.zip) or [avolutions.org](http://avolutions.org/download/avolutions-0.3.0-alpha.zip).
